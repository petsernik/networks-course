...
#### Демонстрация работы
Сначала запускаем клиент, потом сервер
...
#### Демонстрация работы
Можно заметить что в предыдущем задании на втором скриншоте по сравнению с первым скриншотом добавились два файла, 
вот их содержание (т.е. пересылка успешно удалась):
