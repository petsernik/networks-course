...
![1.jpg](screenshoots%2F1.jpg) (скриншот к 1 и 2)
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - сервер добавил единичку к значению acknowledgment number из полученного SYN-пакета из прошлого пункта(было 0)
   - SYNACK, потому что во флагах SYN, ACK
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - 1 --> 642 --> 2102 --> 3562 --> 5022 --> 6482 ...
   - 51.088516 --> 51.088596 --> 51.088596 --> 51.088596 --> 51.088596 --> 51.088596 ...
   - 51.226309(1 пакет) --> 51.226309(9 пакетов) --> ...
   - 0.137793, 0.137713, 0.137713, 0.137713, 0.137713, 0.137713
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - 641/0.137793 первый пакет, 1460/0.137713 остальные девять пакетов
   - mean = (641/0.137793 + 1460/0.137713 * 9) / (1+9) = 10006.7733965 
   - Вычислял так: mean([TSP Segment Len]/RTT)
